# AMAIA-SYNC Runtime Implementation Blueprint v1.1.1

**Type:** Implementation blueprint  
**Status:** Pending hostile implementation audit  
**Supersedes:** v1.1 (micro consistency fix — no architectural or implementation changes)  
...
| # | Type | Fix |
|---|---|---|
| A | Consistency | Bootstrap sequence: replaced "Initialize Supabase client" with pg client via SUPABASE_DB_URL. |
| B | Consistency | Daemon loop shutdown: replaced supabase.close() with pgPool.end(). |
