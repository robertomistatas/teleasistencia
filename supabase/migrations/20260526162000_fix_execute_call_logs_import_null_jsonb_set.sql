-- Fix: keep normalized_payload non-null in execute_call_logs_import when nullable fields are written with jsonb_set.
-- This prevents NOT NULL violations in import_run_rows for invalid_phone/unmatched style rows.
